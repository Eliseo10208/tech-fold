...
const techIconMap: Record<string, TechIconConfig> = {
  ...
  "Apache Airflow": { kind: "remote", src: "https://cdn.simpleicons.org/apacheairflow" },
  APIs: { kind: "generic", glyph: "api" },
  "APIs REST": { kind: "generic", glyph: "api" },
  AWS: { kind: "remote", src: buildTechIconUrl("AWS") },
  "Analytics pipelines": { kind: "generic", glyph: "data" },
  "Arquitectura basada en servicios": { kind: "generic", glyph: "services" },
  "Arquitectura hexagonal": { kind: "generic", glyph: "architecture" },
  "Hexagonal architecture": { kind: "generic", glyph: "architecture" },
  Bash: { kind: "remote", src: buildTechIconUrl("Bash") },
  "CLI básica": { kind: "remote", src: buildTechIconUrl("Bash") },
  "Basic CLI": { kind: "remote", src: buildTechIconUrl("Bash") },
  ...
  CSS3: { kind: "remote", src: buildTechIconUrl("CSS3") },
  Dart: { kind: "remote", src: buildTechIconUrl("Dart") },
  DDD: { kind: "generic", glyph: "architecture" },
  "Domain-Driven Design (DDD)": { kind: "generic", glyph: "architecture" },
  "Diseño de APIs": { kind: "generic", glyph: "api" },
  "API design": { kind: "generic", glyph: "api" },
  "Documentación técnica": { kind: "generic", glyph: "layers" },
  "Technical documentation": { kind: "generic", glyph: "layers" },
  ...
  HTML5: { kind: "remote", src: buildTechIconUrl("HTML5") },
  JavaScript: { kind: "remote", src: buildTechIconUrl("JavaScript") },
  Kotlin: { kind: "remote", src: buildTechIconUrl("Kotlin") },
  Linux: { kind: "remote", src: buildTechIconUrl("Linux") },
  "Kotlin (Android)": { kind: "remote", src: buildTechIconUrl("Kotlin") },
  "Machine learning model API integration": { kind: "generic", glyph: "ai" },
  "Integración de modelos con APIs": { kind: "generic", glyph: "ai" },
  Microservices: { kind: "generic", glyph: "services" },
  MongoDB: { kind: "remote", src: buildTechIconUrl("MongoDB") },
  MariaDB: { kind: "remote", src: "https://cdn.simpleicons.org/mariadb" },
  MySQL: { kind: "remote", src: buildTechIconUrl("MySQL") },
  PostgreSQL: { kind: "remote", src: "https://cdn.simpleicons.org/postgresql" },
  ...
  "npm / package.json": { kind: "remote", src: buildTechIconUrl("NPM") },
  "npm / package json": { kind: "remote", src: buildTechIconUrl("NPM") },
  OpenAI: { kind: "remote", src: "https://cdn.simpleicons.org/openai" },
  "OpenAI API": { kind: "remote", src: "https://cdn.simpleicons.org/openai" },
  "Procesamiento de imágenes": { kind: "generic", glyph: "data" },
  "Image processing": { kind: "generic", glyph: "data" },
  Python: { kind: "remote", src: buildTechIconUrl("Python") },
  "React.js": { kind: "remote", src: buildTechIconUrl("React") },
  React: { kind: "remote", src: buildTechIconUrl("React") },
  "Redes neuronales convolucionales (CNN)": { kind: "generic", glyph: "ai" },
  "Convolutional neural networks (CNN)": { kind: "generic", glyph: "ai" },
  Claude: { kind: "remote", src: "https://cdn.simpleicons.org/anthropic" },
  "Claude API": { kind: "remote", src: "https://cdn.simpleicons.org/anthropic" },
  Redux: { kind: "remote", src: buildTechIconUrl("Redux") },
  "Separación de capas (controllers, services, domain)": {
    kind: "generic",
    glyph: "layers",
  },
  "Layered separation (controllers, services, domain)": {
    kind: "generic",
    glyph: "layers",
  },
  "SSR / SSG": { kind: "generic", glyph: "browser" },
  "Tailwind CSS": { kind: "remote", src: buildTechIconUrl("Tailwind-CSS") },
  "Testing (básico)": { kind: "generic", glyph: "delivery" },
  "Testing (basic)": { kind: "generic", glyph: "delivery" },
  TypeScript: { kind: "remote", src: buildTechIconUrl("TypeScript") },
  Vercel: { kind: "remote", src: buildTechIconUrl("Vercel") },
  Vite: { kind: "remote", src: buildTechIconUrl("Vite.js") },
